...
export function BlogComponent() {
      return (
        <div className="article-container">
          <h1 className="article-title">Exploring the Beauty of Nature</h1>
          <div className="media-section" style={{ position: 'relative' }}>
  <img src="https://i2.wp.com/thenewcamera.com/wp-content/uploads/2016/01/Nikon-D500-Sample-Image-3.jpg" alt="Article Title" className="article-img" />
  <div className="overlay-links">
    <a href="youtube-url" className="media-link">
      <img src="https://upload.wikimedia.org/wikipedia/commons/4/42/YouTube_icon_%282013-2017%29.png" alt="YouTube" className="link-icon" />
      Watch on YouTube
    </a>
    <a href="spotify-url" className="media-link">
      <img src="images/Spotify.png" alt="Spotify" className="link-icon" />
